...
object ColorTokens {
    ...
    val Neutral1_1000 = SwatchColorToken(Swatch.Neutral1, Shade.S1000)

    val Neutral2_0 = SwatchColorToken(Swatch.Neutral2, Shade.S0)
    val Neutral2_10 = SwatchColorToken(Swatch.Neutral2, Shade.S10)
    ...
    val Neutral2_400 = SwatchColorToken(Swatch.Neutral2, Shade.S400)
    ...
    val Neutral2_1000 = SwatchColorToken(Swatch.Neutral2, Shade.S1000)

    val Accent1_0 = SwatchColorToken(Swatch.Accent1, Shade.S0)
    ...
    val Accent1_1000 = SwatchColorToken(Swatch.Accent1, Shade.S1000)

    val Accent2_0 = SwatchColorToken(Swatch.Accent2, Shade.S0)
    ...
    val Accent3_300 = SwatchColorToken(Swatch.Accent3, Shade.S300)
    val Accent3_400 = SwatchColorToken(Swatch.Accent3, Shade.S400)
    val Accent3_500 = SwatchColorToken(Swatch.Accent3, Shade.S500)
    val Accent3_600 = SwatchColorToken(Swatch.Accent3, Shade.S600)
    val Accent3_700 = SwatchColorToken(Swatch.Accent3, Shade.S700)
    val Accent3_800 = SwatchColorToken(Swatch.Accent3, Shade.S800)
    val Accent3_900 = SwatchColorToken(Swatch.Accent3, Shade.S900)
    val Accent3_1000 = SwatchColorToken(Swatch.Accent3, Shade.S1000)
