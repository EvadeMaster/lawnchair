...
public class InvariantDeviceProfile {
     ...
     */
    public GridOption closestProfile; // Lawnchair!
    ...
    public static String getCurrentGridName(Context context) {
        return DeviceProfileOverrides.INSTANCE.get(context).getCurrentGridName(); // Lawnchair!
    }
    ...
    public void onPreferencesChanged(Context context) { // Lawnchair!
     ...
     */
    public List<GridOption> parseAllGridOptions(Context context) { // TODO: LC Static!
    ...
    public static final class GridOption {
        ...
        public GridOption(Context context, AttributeSet attrs) {
            ...
            numColumns = a.getInt(R.styleable.GridDisplayOption_numColumns, 4); // Lawnchair! (AOSP: 0)
            ...
            numDatabaseAllAppsColumns = a.getInt(
                    R.styleable.GridDisplayOption_numExtendedAllAppsColumns, numAllAppsColumns); // Lawnchair! (2 * numAllAppsColumns)
