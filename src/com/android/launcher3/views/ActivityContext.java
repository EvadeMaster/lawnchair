...
import androidx.core.view.WindowInsetsCompat; // TODO: WindowInsetsCompat usage!
...
public interface ActivityContext {
     ...
     */
    default void hideKeyboard() { // TODO: @NullCube - Other branch bizzare adventure - Hide keyboard!
    ...
    default boolean isSoftwareKeyboardHidden() {
        if (isHardwareKeyboard()) {
            ...
            return !insetsCompat.isVisible(WindowInsetsCompat.Type.ime()); // TODO: isVisible usage!
        }
    }
