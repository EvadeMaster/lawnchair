    ...
    private static void getIconResult(Launcher l, View originalView, ItemInfo info, RectF pos,
        ...
        if (info instanceof SystemShortcut) {
            ...
            if (supportsAdaptiveIcons) {
                boolean shouldThemeIcon = originalView instanceof BubbleTextView
                    && ((BubbleTextView) originalView).shouldUseTheme(); // Lawnchair!
                /* TODO: AOSP: (btvIcon instanceof FastBitmapDrawable fbd)
