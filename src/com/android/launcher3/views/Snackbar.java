...
public class Snackbar extends AbstractFloatingView {
    ...
    public static void show(ActivityContext activity, CharSequence labelString,
        ...
        snackbar.setBackground(DrawableTokens.RoundRectPrimary.resolve(snackbar.getContext()));
        ...
        labelView.setTextColor(ColorTokens.TextColorPrimary.resolveColor(actionView.getContext()));
        actionView.setTextColor(ColorTokens.ColorAccent.resolveColor(actionView.getContext()));
        float actionWidth;
