...
public class DeviceProfile {
    ...
    DeviceProfile(Context context, InvariantDeviceProfile inv, Info info, WindowBounds windowBounds,
        ...
        mIconSizeSteps = mIsResponsiveGrid ? new IconSizeSteps(res) : null; // TODO: @NullCube what was this again? AOSP: new IconSizeSteps(res);
        ...
        /* TODO: @NullCube, what is this again? 
            !! AOSP: int hotseatBarBottomSpace;
        */
        ...
        overviewTaskIconSizePx = true ? res.getDimensionPixelSize( // TODO: @pE-Development enableOverviewIconMenu
        ...
        overviewTaskThumbnailTopMarginPx =
                true ? 0 : overviewTaskIconSizePx + overviewTaskMarginPx; // TODO: @pE-Development enableOverviewIconMenu
        ...
        boolean allowLeftRightSplitInPortrait =
                com.android.wm.shell.Flags.enableLeftRightSplitInPortrait() // TODO: @LC-* com.android.wm.shell.Flags.*? who even are you??
    ...
    private void updateHotseatSizes(int hotseatIconSizePx) {
        ...
        var space = Math.abs(hotseatCellHeightPx / 2) - 16; // TODO: @LC-Development space is unused now!
        ...
        if (isVerticalBarLayout()) {
            hotseatBarSizePx = hotseatIconSizePx + mHotseatBarEdgePaddingPx
                    + mHotseatBarWorkspaceSpacePx; // TODO: @LC-Development space go here!
        } else if (isQsbInline) {
            hotseatBarSizePx = Math.max(hotseatIconSizePx, hotseatQsbVisualHeight)
                    + hotseatBarBottomSpacePx; // TODO: @LC-Development space go here!
        } else {
            hotseatBarSizePx = hotseatIconSizePx
                    + hotseatQsbSpace
                    + hotseatQsbVisualHeight
                    + hotseatBarBottomSpacePx;
                    // TODO: @LC-Development + space;
        }
    ...
    private void hideWorkspaceLabelsIfNotEnoughSpace() {
        ...
        if (mIsResponsiveGrid) {
            ...
            // TODO: @LC-Development AOSP None, Lawnchair Yes
    ...
    private void updateAllAppsIconSize(float scale, Resources res) {
        ...
        allAppsCellHeightPx = pxFromDp(inv.allAppsCellSize[mTypeIndex].y, mMetrics, allAppsCellHeightMultiplier) // Lawnchair!
    ...
    private void updateAllAppsContainerWidth() {
        ...
        var marginMultiplier = allAppLeftRightMarginMultiplier * (!isTablet ? 100 : 2); // TODO: @NullCube ? isTablet Null?
        allAppsLeftRightMargin *= marginMultiplier;
        allAppsPadding.left *= marginMultiplier;
    }
