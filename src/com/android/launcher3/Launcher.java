...
//import static com.android.launcher3.config.FeatureFlags.SHOW_DOT_PAGINATION; // TODO: @LC-Development @NullCube - Legacy
...
public class Launcher extends StatefulActivity<LauncherState>
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.setLauncher(this); // Lawnchair! TODO: Have @pE-Development resolved this rebase?
        mOldConfig = new Configuration(getResources().getConfiguration()); // Lawnchair!
        mModel = app.getModel();
     ...
     */
    @NonNull
    @RequiresApi(Build.VERSION_CODES.UPSIDE_DOWN_CAKE) // TOOD: Lawnchair None
    ...
    private void handleActivityResult(
        ...
        if (isWidgetDrop) {
            ...
            if (appWidgetId < 0 || resultCode == RESULT_CANCELED) {
                ...
                if (dropLayout == null) return; // Lawnchair!
    ...
    protected void setupViews() {
        ...
        if (true) { // TODO: @pE-Development legacy
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        if (true && WorkspacePageIndicator.class.getName().equals(name)) { // TODO: @pE-Development legacy
    ...
    void completeAddAppWidget(int appWidgetId, ItemInfo itemInfo,
        ...
        if (appWidgetInfo == null) {
            ...
            if (appWidgetInfo == null) {
                // TODO: @any, What a Terrible Failure! (?)
                Log.d("LC-appWidgetInfo", "appWidgetInfo is still null????");
                return;
            }
        }
        ...
        if (appWidgetInfo.provider == null) {
            ...
            if (appWidgetInfo.provider == null) {
                // TODO: @any, What a Terrible Failure! (?)
                Log.d("LC-appWidgetInfo", "appWidgetInfo.provider is still null???? (after hv)");
                return;
            }
        }
        ...
        if (isActionMain) {
            if (!internalStateHandled) {
                ...
                if (!isInState(NORMAL)) {
                    ...
                    boolean animate = mStateManager.shouldAnimateStateChange(); // Lawnchair! (start)
                    if (!LawnchairApp.isRecentsEnabled()) {
                        animate &= alreadyOnHome;
                    }
                    mStateManager.goToState(NORMAL, animate); // Lawnchair! (end)
                }
                ...
                if (shouldMoveToDefaultScreen && !mWorkspace.isHandlingTouch()) {
                    if (mWorkspace.getNextPage() != Workspace.DEFAULT_PAGE) { // Lawnchair!
    ...
    public void handleHomeTap() {} // Lawnchair
    ...
    public void bindComplete(int workspaceItemCount, boolean isBindSync) {
        ...
        MAIN_EXECUTOR.getHandler().postAtFrontOfQueue(() -> {
            mStartupLatencyLogger
                    ...
                    .reset();
            if (mIsColdStartupAfterReboot) {
                if (Utilities.ATLEAST_Q) { // TODO: @reviewer @pE-qa Used to be S
