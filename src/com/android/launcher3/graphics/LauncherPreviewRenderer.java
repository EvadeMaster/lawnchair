...
public class LauncherPreviewRenderer extends ContextWrapper
    ...
    private void inflateAndAddWidgets(
        ...
        if (mWallpaperColorResources != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) { // TODO: ATLEAST_S Check instead
    ...
    private void populate(BgDataModel dataModel,
        ...
        // Add first page QSB
        if (FeatureFlags.QSB_ON_FIRST_SCREEN(mContext) && dataModel.isFirstPagePinnedItemEnabled
