...
import android.content.SharedPreferences; // TODO: @pE-Development(rebase) AOSP: None, Lawnchair: Yes (?)
...
public final class Utilities {
    ...
    @ChecksSdkIntAtLeast(api = VERSION_CODES.O) // Lawnchair!
    public static final boolean ATLEAST_O = Build.VERSION.SDK_INT >= Build.VERSION_CODES.O;

    @ChecksSdkIntAtLeast(api = VERSION_CODES.O_MR1) // Lawnchair!
    ...
    @ChecksSdkIntAtLeast(api = VERSION_CODES.S_V2) // Lawnchair!
     ...
     */
    @Deprecated
    public static final boolean IS_DEBUG_DEVICE = true; // Lawnchair!
    ...
    public static void mapCoordInSelfToDescendant(View descendant, View root, float[] coord) {
        if (descendant == null || root == null || coord == null || coord.length < 2) return;  // Lawnchair! - A9 Fix
        sMatrix.reset();
        View v = descendant;
        while(v != root) {
     ...
     */
    @SuppressLint("UseCompatLoadingForDrawables") // TODO: @NullCube !! Insanely huge difference !!
    @Nullable
    @WorkerThread
    public static <T extends Context & ActivityContext> Pair<AdaptiveIconDrawable, Drawable>
        ...
        if (ATLEAST_T && info instanceof PendingAddShortcutInfo) { // AOSP: None, Lawnchair: Check for T
            ...
            if (activityInfo == null) {
                return null; // TODO: @NullCube - launcher3-bizzare-adventure !! Mid Difference
                /* 
                *             
        ...
        if (badge == null) {
            ...
            // TODO: @NullCube - launcher3-bizzare-adventure !! Mid Difference
            /*
    ...
    /* TODO: @pE-Development(rebase) - SharedPrefs? AOSP: None, Lawnchair: Yes*/
