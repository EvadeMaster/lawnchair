...
public class CellLayout extends ViewGroup {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDragOutlinePaint.setColor(ColorTokens.WorkspaceAccentColor.resolveColor(getContext())); // TODO: @LC-Development AOSP: workspaceTextColor is use!
    ...
    public boolean isOccupied(int x, int y) {
        if (x >= 0 && x < mCountX && y >= 0 && y < mCountY) { // TODO: @LC-Housekeeping @LC-Development Minor difference, also what is this????
            return mOccupied.cells[x][y]
                && !PreferenceExtensionsKt.firstBlocking(mPreferenceManager2.getAllowWidgetOverlap()); // Lawnchair!
        } else {
            throw new RuntimeException("Position exceeds the bound of this CellLayout");
        }
        return true; // TODO: @pE-Development(rebase) @any-Housekeeping what is this?
    }
