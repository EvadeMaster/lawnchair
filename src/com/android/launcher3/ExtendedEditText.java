 ...
 */
public class ExtendedEditText extends EditText { // TODO: @LC-Housekeeping Should Extend androidx.appcompat.widget.AppCompatEditText?
    ...
    public void hideKeyboard() { // TODO: @NullCube - bizzare something adventure - Hide keyboard
        hideKeyboard(/* clearFocus= */ true);
    }

    public void hideKeyboard(boolean clearFocus) {
        ActivityContext.lookupContext(getContext()).hideKeyboard(); // TODO: @NullCube - bizzare something adventure - Hide keyboard
        if (clearFocus) {
            clearFocus();
        }
    }
