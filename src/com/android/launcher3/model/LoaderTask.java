...
public class LoaderTask implements Runnable {
    ...
    public void run() {
        ...
        try (LauncherModel.LoaderTransaction transaction = mApp.getModel().beginLoader(this)) {
            ...
            if (SMARTSPACE_AS_A_WIDGET.get() && prefs.get(SHOULD_SHOW_SMARTSPACE)) { //TODO:SHOULD_SHOW_SMARTSPACE
                mLauncherBinder.bindSmartspaceWidget();
                // Turn off pref.
                prefs.putSync(SHOULD_SHOW_SMARTSPACE.to(false));
                logASplit("bindSmartspaceWidget");
                verifyNotStopped();
            } else if (!SMARTSPACE_AS_A_WIDGET.get() && true //TODO:WIDGET_ON_FIRST_SCREEN
    ...
    protected void loadWorkspace(
        ...
        mBgDataModel.isFirstPagePinnedItemEnabled = true //TODO:FeatureFlags.QSB_ON_FIRST_SCREEN
    ...
    private void loadWorkspaceImpl(
        ...
        synchronized (mBgDataModel) {
            ...
            List<FolderGridOrganizer> verifiers =
                null;
            if (Utilities.ATLEAST_U) {
                verifiers = mApp.getInvariantDeviceProfile().supportedProfiles.stream().map(
    ...
    private List<LauncherActivityInfo> loadAllApps() {
        ...
        for (UserHandle user : profiles) {
            ...
            for (int i = 0; i < apps.size(); i++) {
                ...
                mBgAllAppsList.add(
                        appInfo, app, !enableBulkLoading); // TODO: last param is always false in AOSP
            }
        ...
        if (FeatureFlags.PROMISE_APPS_IN_ALL_APPS.get()) {
            ...
            for (PackageInstaller.SessionInfo info :
                ...
                AppInfo promiseAppInfo = mBgAllAppsList.addPromiseApp(
                        ...
                        !enableBulkLoading); // TODO: last param is always false in AOSP
        ...
        if (enableBulkLoading) { // TODO: Bulk check is not on AOSP
