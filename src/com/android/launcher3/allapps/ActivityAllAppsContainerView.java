...
import com.android.launcher3.keyboard.FocusedItemDecorator; // TODO: @pE Hey look! maybe we can fix the focused decorator not working in allapps search in Lawnchair!
...
public class ActivityAllAppsContainerView<T extends Context & ActivityContext>
    ...
    private static final long DEFAULT_SEARCH_TRANSITION_DURATION_MS = 300; // TODO: LC set to 0 due to glitch anim
    ...
    protected void initContent() {
        ...
        mAH.set(AdapterHolder.MAIN, new AdapterHolder(AdapterHolder.MAIN,
                new AlphabeticalAppsList<>(mActivityContext,
                        mAllAppsStore,
                        null,
                        mPrivateProfileManager))); // TODO: LawnchairAlphabeticalAppsList
        mAH.set(AdapterHolder.WORK, new AdapterHolder(AdapterHolder.WORK,
                new AlphabeticalAppsList<>(mActivityContext, mAllAppsStore, mWorkManager, null))); // TODO: LawnchairAlphabeticalAppsList
        mAH.set(SEARCH, new AdapterHolder(SEARCH,
                new AlphabeticalAppsList<>(mActivityContext, null, null, null))); // TODO: LawnchairAlphabeticalAppsList
    ...
    protected void updateHeaderScroll(int scrolledOffset) {
        ...
        // TODO: @SuperDragonXD, this change was reverted... oops
    ...
    private void setDeviceManagementResources() {
        if (mActivityContext.getStringCache() != null) {
            ...
            personalTab.setAllCaps(false); // TODO: Allcaps?
            ...
            workTab.setAllCaps(false); // TODO: Allcaps?
        ...
        if (workRV != null) {
            for (int i = 0; i < workRV.getChildCount(); i++) {
                ...
                if (currentItemViewType == VIEW_TYPE_WORK_EDU_CARD) {
                    ...
                    ((WorkPausedCard) currentView).setWorkProfilePausedResources(); // TODO: AOSP: updateStringFromCache()
                }
            }
        }
    }
