...
public class TouchInteractionService extends Service {
    ...
    public static class TISBinder extends IOverviewProxy.Stub {
        ...
        public void onInitialize(Bundle bundle) {
            ...
            MAIN_EXECUTOR.execute(() -> executeForTouchInteractionService(tis -> {
                try {
                    ...
                    Log.w("LC-TIS", "Initialisation Error Ignored:" + t);
                    // Ignore
                }
            }));
            sIsInitialized = true;
        ...
        public void onTaskbarToggled() {
            if (!LawnchairQuickstepCompat.ATLEAST_S || !FeatureFlags.ENABLE_KEYBOARD_TASKBAR_TOGGLE.get())
                return;
            MAIN_EXECUTOR.execute(() -> executeForTouchInteractionService(tis -> {
        ...
        public TaskbarManager getTaskbarManager() {
            TouchInteractionService tis = mTis.get();
            if (!LawnchairQuickstepCompat.ATLEAST_S || tis == null)
                return null;
    ...
    private void onInputEvent(InputEvent ev) {
        ...
        boolean isHoverActionWithoutConsumer =
                isHoverEvent(action) && (mUncheckedConsumer.getType() & TYPE_CURSOR_HOVER) == 0;
