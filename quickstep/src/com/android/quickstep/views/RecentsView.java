...
public abstract class RecentsView<ACTIVITY_TYPE extends StatefulActivity<STATE_TYPE>,
    ...
    public void createTaskDismissAnimation(PendingAnimation anim, TaskView dismissedTaskView,
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child == dismissedTaskView) {
                ...
                // TODO: Recent Animation is missing, LiveTitle is enabled... hopefully I can pull it back
                if (scrollDiff != 0) {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            switch (event.getKeyCode()) {
                /* TODO: Hey look! Ripe to be colonised for LC prefsManager
                    Yeah I'm descenting into insanity because of like 400 changes and 11 conflicts in this file */
    ...
    public void finishRecentsAnimation(boolean toRecents, boolean shouldPip,
        ...
        final boolean sendUserLeaveHint = LawnchairQuickstepCompat.ATLEAST_S && toRecents && shouldPip;
