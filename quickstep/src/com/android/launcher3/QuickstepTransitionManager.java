...
public class QuickstepTransitionManager implements OnDeviceProfileChangeListener {
    ...
    public QuickstepTransitionManager(Context context) {
        ...
        mBackAnimationController = LawnchairApp.isAtleastT() 
                ? new LauncherBackAnimationController(mLauncher, this)
                : null;
    ...
    public void registerRemoteAnimations() {
        if (!Utilities.ATLEAST_S || SEPARATE_RECENTS_ACTIVITY.get()) {
            return;
        }
    ...
    public void registerRemoteTransitions() {
        if (!Utilities.ATLEAST_T || SEPARATE_RECENTS_ACTIVITY.get()) return;
        ...
        mLauncherOpenTransition = new LawnchairQuickstepCompat.getRemoteTransitionCompat().getRemoteTransition(
