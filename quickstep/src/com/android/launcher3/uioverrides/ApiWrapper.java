...
import java.util.Collections; // TODO: LC: Yes, AOSP: None
...
public class ApiWrapper {
    ...
    public static Person[] getPersons(ShortcutInfo si) {
        if (!Utilities.ATLEAST_Q) return Utilities.EMPTY_PERSON_ARRAY; // Lawnchair!
    ...
    public static Map<String, LauncherActivityInfo> getActivityOverrides(Context context) {
        ...
        // AOSP: return context.getSystemService(LauncherApps.class).getActivityOverrides();
    }
